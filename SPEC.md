...
- Normal users can create household-visible projects.
...
```text
/data/<username>/<project>/<note_id>.source.<original-extension>
```
...
```text
/data/<username>/<project>/<note_id>.source.txt
```
...
Projects are visible to the household. `user_id` records who created the project and
...
7. Save the Markdown file under `/data/<username>/<project>/<note_id>.md`.
